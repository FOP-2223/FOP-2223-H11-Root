...
public class H11_RubricProvider implements RubricProvider {
    ...
    private static final Criterion H1_1 = Criterion.builder()
        ...
        .grader(Grader.testAwareBuilder()
            .requirePass(JUnitTestRef.ofMethod(() -> AlgaeTest.class.getMethod("testThat_aIsAxiom")))
            .pointsFailedMin()
            .pointsPassedMax()
            .build())
        .build();
    private static final Criterion H1_2 = Criterion.builder()
        ...
        .grader(Grader.testAwareBuilder()
            .requirePass(JUnitTestRef.ofMethod(() -> AlgaeTest.class.getMethod("testProjectOfA")))
            .requirePass(JUnitTestRef.ofMethod(() -> AlgaeTest.class.getMethod("testProjectOfB")))
            .pointsFailedMin()
            .pointsPassedMax()
            .build())
        .build();
